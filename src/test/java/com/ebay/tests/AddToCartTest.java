...
public class AddToCartTest {
	...
	@Test(dataProvider="XmlData",groups={"smoke","all","VerifyAddingToCart"})
	public void VerifyAddingToCart(IBrowserConf browserConf, IProperty prop)
	{
		...
		sAssert.assertTrue(prof.cartPage().verifyProductInCart(), "Verify product in cart");
	}
